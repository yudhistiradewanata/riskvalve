namespace Riskvalve.Models
{
    ...
    public class ConditionLimitStateModel
    {
        ...
        {
            List<ConditionLimitStateModel> conditionLimitStates = new()
            {
    ...
    public class InspectionEffectivenessModel
    {
        ...
        public List<InspectionEffectivenessModel> GetInspectionEffectivenessStates()
        {
            ...
            {
                new InspectionEffectivenessModel { Id = 1, Effectiveness = "Hightly Effective" },
                new InspectionEffectivenessModel { Id = 2, Effectiveness = "Ussualy Effective" },
    ...
    public class IsValveRepairedModel
    {
        ...
        {
            List<IsValveRepairedModel> isValveRepaired = new()
            {
