...
public class AssessmentController(IAreaService areaService, IAssessmentService assessmentService)
    : Controller
{
    ...
    public IActionResult Index()
    {
        ...
        ViewData["UsedWithinOEMSpecificationData"] =
            _assessmentService.UsedWithinOEMSpecificationDatas();
    ...
    public IActionResult PrintAssessment(int id)
    {
        ...
        Dictionary<string, Dictionary<string, string>> assessmentHeatMap =
            new()
            {
                {
                    "TP1",
    ...
    public IActionResult GetAssessmentSidebar(int AssetID)
    {
        ...
        assessmentSidebar =
        [
            .. assessmentSidebar.OrderByDescending(i =>
