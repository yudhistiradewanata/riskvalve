const urlupdateinspection = getInputVal('#urlupdateinspection')
const urladdinspection = getInputVal('#urladdinspection')
const urldeleteinspection = getInputVal('#urldeleteinspection')
const urlgetassetdetail = getInputVal('#urlgetassetdetail')
const urlgetinspectiondetail = getInputVal('#urlgetinspectiondetail')
const urlinspectionprint = getInputVal('#urlinspectionprint')
