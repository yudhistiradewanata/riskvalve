...
CREATE TABLE Riskvalve.dbo.ImpactEffect (
	...
	ImpactEffectValue float NULL,
	Weighting float NULL,
	Weighting2 float NULL,
...
-- Riskvalve.dbo.RecommendationAction definition

-- Drop table

-- DROP TABLE Riskvalve.dbo.RecommendationAction;

CREATE TABLE Riskvalve.dbo.RecommendationAction (
	ID int IDENTITY(1,1) NOT NULL,
...
CREATE TABLE Riskvalve.dbo.UsedWithinOEMSpecification (
	...
	UsedWithinOEMSpecificationValue float NULL,
	Weighting float NULL,
...
CREATE TABLE Riskvalve.dbo.Assessment (
	...
	CONSTRAINT FK_Assesment_RecomendedAction FOREIGN KEY (RecommendationActionID) REFERENCES Riskvalve.dbo.RecommendationAction(ID),
