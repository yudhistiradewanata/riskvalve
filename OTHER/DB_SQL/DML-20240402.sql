...
INSERT INTO Riskvalve.dbo.ToxicOrFlamableFluid (ToxicOrFlamableFluid) VALUES
	 (N'Yes'),
	 (N'No');
INSERT INTO Riskvalve.dbo.[User] (Username,Password,[Role],IsAdmin,IsEngineer,IsViewer) VALUES
	 (N'Aldo',N'$2a$11$O5bjbyUQrpEfRBROnnCAW.VNgr.NDxWXc.9U1VlZNyGg7qoZuPvZa',N'Surface Facility Admin',1,0,0),
	 (N'yudhis',N'$2a$11$dxVcbita2Ti7HRqrD.n5suITeZOdOrjKQ.molD0YLI4iuMamjy2Te',N'Engineer',1,1,0),
	 (N'viewer',N'$2a$11$AwL9abc4nOQwsMyQrDwe5u93zQI1Xk.Y3pkuwIzSdmbzEQDoFBn/y',N'Viewer',0,0,1);
