    ...
    public AssetData GetAsset(int id)
    {
        ...
        var result =
            ...
            select new AssetData
            {
                ...
                Size = SharedEnvironment.HtmlEncode((asset.Size ?? string.Empty).Replace(',', '.')),
                ...
                OperatingTemperature = SharedEnvironment.HtmlEncode((asset.OperatingTemperature ?? string.Empty).Replace(',','.')),
                OperatingPressure = SharedEnvironment.HtmlEncode((asset.OperatingPressure ?? string.Empty).Replace(',','.')),
                FlowRate = SharedEnvironment.HtmlEncode((asset.FlowRate ?? string.Empty).Replace(',','.')),
                ...
                CostOfReplacementAndRepair = SharedEnvironment.HtmlEncode((asset.CostOfReplacementAndRepair ?? string.Empty).Replace(',','.')),
