    ...
    public AssessmentData GetAssessment(int id)
    {
        ...
        var result = 
            ...
            select new AssessmentData
            {
                ...
                AssessmentNo = HttpUtility.HtmlEncode(assessment.AssessmentNo),
                AssessmentDate = assessment.AssessmentDate,
                TimePeriode = HttpUtility.HtmlEncode(assessment.TimePeriode),
                TimeToLimitStateLeakageToAtmosphere = HttpUtility.HtmlEncode(assessment.TimeToLimitStateLeakageToAtmosphere),
                TimeToLimitStateFailureOfFunction = HttpUtility.HtmlEncode(assessment.TimeToLimitStateFailureOfFunction),
                TimeToLimitStatePassingAccrosValve = HttpUtility.HtmlEncode(assessment.TimeToLimitStatePassingAccrosValve),
                ...
                ProductLossDefinition = HttpUtility.HtmlEncode(assessment.ProductLossDefinition),
                HSSEDefinisionID = assessment.HSSEDefinisionID,
                Summary = HttpUtility.HtmlEncode(assessment.Summary),
                RecommendationActionID = assessment.RecommendationActionID,
                DetailedRecommendation = HttpUtility.HtmlEncode(assessment.DetailedRecommendation),
                ConsequenceOfFailure = HttpUtility.HtmlEncode(assessment.ConsequenceOfFailure),
                TP1A = HttpUtility.HtmlEncode(assessment.TP1A),
                TP1B = HttpUtility.HtmlEncode(assessment.TP1B),
                TP1C = HttpUtility.HtmlEncode(assessment.TP1C),
                TP2A = HttpUtility.HtmlEncode(assessment.TP2A),
                TP2B = HttpUtility.HtmlEncode(assessment.TP2B),
                TP2C = HttpUtility.HtmlEncode(assessment.TP2C),
                TP3A = HttpUtility.HtmlEncode(assessment.TP3A),
                TP3B = HttpUtility.HtmlEncode(assessment.TP3B),
                TP3C = HttpUtility.HtmlEncode(assessment.TP3C),
                TPTimeToActionA = HttpUtility.HtmlEncode(assessment.TPTimeToActionA),
                TPTimeToActionB = HttpUtility.HtmlEncode(assessment.TPTimeToActionB),
                TPTimeToActionC = HttpUtility.HtmlEncode(assessment.TPTimeToActionC),
                TP1Risk = HttpUtility.HtmlEncode(assessment.TP1Risk),
                TP2Risk = HttpUtility.HtmlEncode(assessment.TP2Risk),
                TP3Risk = HttpUtility.HtmlEncode(assessment.TP3Risk),
                TPTimeToActionRisk = HttpUtility.HtmlEncode(assessment.TPTimeToActionRisk),
                ...
                IntegrityStatus = HttpUtility.HtmlEncode(assessment.IntegrityStatus),
                IsDeleted = assessment.IsDeleted,
                CreatedBy = assessment.CreatedBy,
                CreatedAt = assessment.CreatedAt,
                DeletedBy = assessment.DeletedBy,
                DeletedAt = assessment.DeletedAt,
                LeakageToAtmosphere = HttpUtility.HtmlEncode(subleakagetoatmosphere.CurrentConditionLimitState ?? ""),
                FailureOfFunction = HttpUtility.HtmlEncode(subfailureoffunction.CurrentConditionLimitState ?? ""),
                PassingAccrosValve = HttpUtility.HtmlEncode(subpassingacrossvalve.CurrentConditionLimitState ?? ""),
                LeakageToAtmosphereTP1 = HttpUtility.HtmlEncode(subleakeagetoatmospheretp1.TimeToLimitState ?? ""),
                LeakageToAtmosphereTP2 = HttpUtility.HtmlEncode(subleakeagetoatmospheretp2.TimeToLimitState ?? ""),
                LeakageToAtmosphereTP3 = HttpUtility.HtmlEncode(subleakeagetoatmospheretp3.TimeToLimitState ?? ""),
                FailureOfFunctionTP1 = HttpUtility.HtmlEncode(subfailureoffunctiontp1.TimeToLimitState ?? ""),
                FailureOfFunctionTP2 = HttpUtility.HtmlEncode(subfailureoffunctiontp2.TimeToLimitState ?? ""),
                FailureOfFunctionTP3 = HttpUtility.HtmlEncode(subfailureoffunctiontp3.TimeToLimitState ?? ""),
                PassingAccrosValveTP1 = HttpUtility.HtmlEncode(subpassingacrossvalvetp1.TimeToLimitState ?? ""),
                PassingAccrosValveTP2 = HttpUtility.HtmlEncode(subpassingacrossvalvetp2.TimeToLimitState ?? ""),
                PassingAccrosValveTP3 = HttpUtility.HtmlEncode(subpassingacrossvalvetp3.TimeToLimitState ?? ""),
                InspectionEffectiveness = HttpUtility.HtmlEncode(subinspectioneffectiveness.Effectiveness ?? ""),
                ImpactOfInternalFluidImpurities = HttpUtility.HtmlEncode(subimpactofinternalfluidimpurities.ImpactEffect ?? ""),
                ImpactOfOperatingEnvelopes = HttpUtility.HtmlEncode(subimpactofoperatingenvelope.ImpactEffect ?? ""),
                UsedWithinOEMSpecification = HttpUtility.HtmlEncode(subusedwithinoemspecifications.UsedWithinOEMSpecification ?? ""),
                Repaired = HttpUtility.HtmlEncode(subrepaired.Repaired ?? ""),
                HSSEDefinision = HttpUtility.HtmlEncode(subhssedefinision.HSSEDefinision ?? ""),
                RecommendationAction = HttpUtility.HtmlEncode(subrecomendationaction.RecommendationAction ?? ""),
