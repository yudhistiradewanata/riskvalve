    ...
    public AssessmentData GetAssessment(int id)
    {
        ...
        var result = 
            ...
            select new AssessmentData
            {
                ...
                LeakageToAtmosphere = subleakagetoatmosphere.CurrentConditionLimitState ?? "",
                FailureOfFunction = subfailureoffunction.CurrentConditionLimitState ?? "",
                PassingAccrosValve = subpassingacrossvalve.CurrentConditionLimitState ?? "",
                LeakageToAtmosphereTP1 = subleakeagetoatmospheretp1.TimeToLimitState ?? "",
                LeakageToAtmosphereTP2 = subleakeagetoatmospheretp2.TimeToLimitState ?? "",
                LeakageToAtmosphereTP3 = subleakeagetoatmospheretp3.TimeToLimitState ?? "",
                FailureOfFunctionTP1 = subfailureoffunctiontp1.TimeToLimitState ?? "",
                FailureOfFunctionTP2 = subfailureoffunctiontp2.TimeToLimitState ?? "",
                FailureOfFunctionTP3 = subfailureoffunctiontp3.TimeToLimitState ?? "",
                PassingAccrosValveTP1 = subpassingacrossvalvetp1.TimeToLimitState ?? "",
                PassingAccrosValveTP2 = subpassingacrossvalvetp2.TimeToLimitState ?? "",
                PassingAccrosValveTP3 = subpassingacrossvalvetp3.TimeToLimitState ?? "",
                InspectionEffectiveness = subinspectioneffectiveness.Effectiveness ?? "",
                ImpactOfInternalFluidImpurities = subimpactofinternalfluidimpurities.ImpactEffect ?? "",
                ImpactOfOperatingEnvelopes = subimpactofoperatingenvelope.ImpactEffect ?? "",
                UsedWithinOEMSpecification = subusedwithinoemspecifications.UsedWithinOEMSpecification ?? "",
                Repaired = subrepaired.Repaired ?? "",
                HSSEDefinision = subhssedefinision.HSSEDefinision ?? "",
                RecommendationAction = subrecomendationaction.RecommendationAction ?? "",
