    ...
    public AssessmentData GetAssessment(int id)
    {
        ...
        var result = 
            ...
            select new AssessmentData
            {
                ...
                TimePeriode = SharedEnvironment.HtmlEncode((assessment.TimePeriode ?? string.Empty).Replace(',','.')),
                TimeToLimitStateLeakageToAtmosphere = SharedEnvironment.HtmlEncode((assessment.TimeToLimitStateLeakageToAtmosphere ?? string.Empty).Replace(',','.')),
                TimeToLimitStateFailureOfFunction = SharedEnvironment.HtmlEncode((assessment.TimeToLimitStateFailureOfFunction ?? string.Empty).Replace(',','.')),
                TimeToLimitStatePassingAccrosValve = SharedEnvironment.HtmlEncode((assessment.TimeToLimitStatePassingAccrosValve ?? string.Empty).Replace(',','.')),
                ...
                ProductLossDefinition = SharedEnvironment.HtmlEncode((assessment.ProductLossDefinition ?? string.Empty).Replace(',','.')),
